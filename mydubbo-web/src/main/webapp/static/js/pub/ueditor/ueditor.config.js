...
(function () {
     ...
     */
	window.UEDITOR_HOME_URL = ctx + "/static/js/pub/ueditor/";//编辑器项目路径
    var URL = window.UEDITOR_HOME_URL || getUEBasePath();
    var controllerURL = ctx+"/ueditor";
    ...
    window.UEDITOR_CONFIG = {
        ...
        //图片上传配置区
        ,imageUrl: ctx +"/common/image/upload"             //图片上传提交地址 edited by 杨帆
        ,imagePath: ctx +"/common/image/load/"                     //图片修正地址，引用了fixedImagePath,如有特殊需求，可自行配置edited by 杨帆
        ...
        //附件上传配置区
        ,fileUrl:controllerURL+"fileUp"               //附件上传提交地址
